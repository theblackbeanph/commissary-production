...
import {
  db, COLLECTIONS, saveDoc, deleteDocument,
...
import {
  BUFFER, RISK_HIGH, RISK_LOW, CLEAR_PIN,
  SKUS, RECIPES, RECIPE_PROD_TYPE, SKU_RECIPES,
  TEAM,
} from "./data";
import {
...
export default function App() {
  ...
  const [subview,      setSubview]     = useState<"list"|"form"|"single"|"mixed"|"split"|"batchdetail">("list");
